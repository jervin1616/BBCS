/* ============================================================
   ...
   Handles: component injection, nav, mobile menu, forms, FAQ
   ============================================================ */
  ...
  <div class="container">
    <div class="header-inner">
      <a href="${SITE_ROOT}/" class="logo" aria-label="Busy B's Cleaning Service Home">
        ...
        <div class="logo-text">
          <span class="logo-name">Busy B's Cleaning</span>
          <span class="logo-tagline">Wilmington, NC &mdash; Veteran Owned</span>
        </div>
      </a>
      ...
      <div class="header-cta">
        <a href="tel:9107464663" class="header-phone btn-header-hide" aria-label="Call us">
          📞 (910) 746-4663
        </a>
...
<footer id="site-footer">
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-brand">
        <a href="${SITE_ROOT}/" class="logo" style="margin-bottom:1rem;display:inline-flex;">
          <div class="logo-icon" aria-hidden="true">🐝</div>
          <div class="logo-text">
            <span class="logo-name">Busy B's Cleaning</span>
            <span class="logo-tagline">Wilmington, NC</span>
          </div>
        </a>
        ...
        <div class="footer-social" style="margin-top:1rem;">
          <a href="https://www.facebook.com/p/Busy-Bs-Cleaning-Services-100075826284703/" target="_blank" rel="noopener noreferrer" class="social-btn" aria-label="Facebook">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
          </a>
          <a href="https://www.tiktok.com/@busybcleaningservice" target="_blank" rel="noopener noreferrer" class="social-btn" aria-label="TikTok">
      ...
      <div>
        ...
        <div class="footer-areas">
          ...
          Wilmington · Carolina Beach · Kure Beach · Leland · Hampstead · Burgaw · Southport · Oak Island · Castle Hayne · Ogden
        </div>
      </div>
  ...
  <div class="footer-bottom">
    <div class="container">
      <p>&copy; <span id="footer-year"></span> Busy B's Cleaning Service LLC. All rights reserved.
      Wilmington, NC &bull; (910) 746-4663 &bull; Licensed &bull; Insured &bull; Veteran-Owned</p>
    </div>
  </div>
</footer>

<!-- Floating Phone Button (mobile) -->
<a href="tel:9107464663" class="float-phone" aria-label="Call Busy B's Cleaning Service">
...
function injectComponents() {
  ...
  // Initialize header behaviors after injection
  initHeader();
  initMobileMenu();
  highlightActiveNav();
}
...
function highlightActiveNav() {
  ...
  document.querySelectorAll('#site-header .main-nav a, #mobile-nav a').forEach(link => {
    ...
    if (!href) return;
    // Normalize: strip SITE_ROOT prefix for comparison
...
function initContactForm() {
  ...
  form.addEventListener('submit', function(e) {
    ...
    /*
     * TO CONNECT THIS FORM TO FORMSPREE:
     * 1. Sign up at https://formspree.io
     * 2. Create a new form and copy your endpoint URL
     * 3. Replace the action attribute below with your Formspree endpoint
     *    e.g. "https://formspree.io/f/YOUR_FORM_ID"
     * 4. Remove the preventDefault() above and let the form submit normally,
     *    OR keep using fetch() below with the Formspree endpoint.
     */
